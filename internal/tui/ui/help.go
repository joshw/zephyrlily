...
var tuiHelp = map[string][]string{
	...
	"lastcol": {
		...
		"never create the state, so neither bug can fire. It is ON by default;",
		"the cost is one column of typing room.",
		"",
		...
		"",
		"Turn it OFF to observe the bugs. The snapshot records the setting.",
	},
	"redraw": {
