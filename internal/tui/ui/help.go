...
var tuiHelp = map[string][]string{
	...
	"page": {
		"Toggle the viewport pager and mouse-wheel scrolling",
		"",
		"Usage: %page on|off",
		"       %page wheel on|off",
		"",
		...
		"",
		"'%page wheel on' enables mouse-wheel scrolling of the output (off by",
		"default). It captures the mouse, which breaks click-drag text",
		"selection unless you hold a bypass modifier (Shift on most terminals,",
		"Option in iTerm2, Fn in macOS Terminal.app) while dragging.",
		"Use '%page wheel' with no argument to show the current setting.",
	},
	"style": {
